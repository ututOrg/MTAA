  ...
  return (
    <div className="space-y-8">
      ...
      <div className="space-y-2">
        <h1 className="text-4xl text-white">Sales Dashboard</h1>
        <p className="text-sm text-gray-400">Monitor sales performance and revenue trends</p>
      </div>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <Card className="border-white/10 bg-gradient-to-br from-white/10 to-white/5 p-6 backdrop-blur-sm">
          <div className="mb-4 flex items-center justify-between">
            <div>
              <h3 className="text-lg text-white">Revenue vs Target</h3>
        ...
        <Card className="border-white/10 bg-gradient-to-br from-white/10 to-white/5 p-6 backdrop-blur-sm">
          <div className="mb-4 flex items-center justify-between">
            <div>
              <h3 className="text-lg text-white">Sales by Category</h3>
              <p className="text-xs text-gray-400">Top performing categories</p>
            </div>
            <button className="rounded-lg bg-white/5 px-3 py-1.5 text-xs text-gray-300 hover:bg-white/10">
              This month ▼
            </button>
      ...
      <Card className="border-white/10 bg-gradient-to-br from-white/10 to-white/5 p-6 backdrop-blur-sm">
        <div className="mb-4 flex items-center justify-between">
          <div>
            <h3 className="text-lg text-white">Revenue Growth Trend</h3>
            <p className="text-xs text-gray-400">Monthly revenue progression</p>
          </div>
          <button className="rounded-lg bg-white/5 px-3 py-1.5 text-xs text-gray-300 hover:bg-white/10">
            7 months ▼
          </button>
