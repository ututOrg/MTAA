...
const OFFICE_DATA: Record<string, OfficeItem> = {
    "УТУТ": {
        id: "ID-01", stats: "342", unit: "Ус түгээх ухаалаг систем",
        desc: "Millennium Challenge Account–Mongolia (MCA–Mongolia)-ийн дэмжлэгээр 180 ухаалаг ус түгээх байр нэмж суурилуулснаар нийт 326 байрыг ухаалаг төхөөрөмжөөр тоноглон тусдаа  бие даасан ухаалаг хяналтын системээр удирдахаас гадна тэдгээрийн засвар үйлчилгээний үйл ажиллагааг хариуцдаг\n",
        engineer: 1, tex: 4,
    ...
    "ТЕЛЕМЕТР": {
        id: "ID-02", stats: "73", unit: "Цэг",
        desc: "Цэвэр усны төв шугамын даралт, урсгал, температурын мэдээллийг бодит хугацаанд хянаж, дамжуулах зориулалттай Телеметр хяналтын систем нь ус хангамжийн найдвартай ажиллагааг хангах дижитал хяналт, удирдлагын технологийн цогц шийдэл юм\n",
        engineer: 1, tex: 1,
        img: "/src/assets/pc-3d.png", icon: "💈",
        color: "#ef4444", bgAlpha: "rgba(239,68,68,0.08)",
        chart: [30, 50, 80, 40, 90, 70, 60, 85, 45, 55],
    },
    "GPS": {
        id: "ID-03", stats: "113", unit: "Төхөөрөмж",
        desc: "Байгууллагын  тээврийн хэрэгслийн байршил,хөдөлгөөний хяналтын системд  GPS-байршил болон түлшний зарцуулалтыг 13 төрлийн тайлангаар хянаж үр ашигтай ажиллах нөхцлөөр ханган ажилладаг систем юм\n",
        engineer: 1, tex: 1,
        img: "/src/assets/network-3d.png", icon: "🛰️",
        color: "#06b6d4", bgAlpha: "rgba(6,182,212,0.08)",
        chart: [60, 85, 70, 95, 80, 65, 90, 75, 85, 100],
    },
    "НЭГ ЦЭГ": {
        id: "ID-04", stats: "164", unit: "Цэг",
        desc: "Улаанбаатар хотын томоохон хэрэглээ бүхий ус дамжуулах дэд төв (УДДТ) болон ус түгээх үзелүүдийн усны хэрэглээ, шугамын даралтыг бодит цагийн горимд хянадаг\n",
        engineer: 1, repairman: 1,
        img: "/src/assets/telecom-3d.png", icon: "🖲️",
...
export default function DataSection() {
    ...
    const [activeTab, setActiveTab] = useState("УТУТ");
        ...
        <div className="w-full max-w-7xl mx-auto p-6 space-y-8 font-sans antialiased">
            ...
            >
              ...
              {d.unit}
                            ...
                            <p className="text-[13px] text-left leading-relaxed mb-5" style={{color: "#64748b"}}>
                                {d.desc}
                            </p>
                  ...
                  Идэвхтэй үйл ажиллагаа
                        ...
                        <GlassCard className="p-6 flex flex-col justify-between"
                            ...
                            <div>
                                ...
                                >
                                    {(d.engineer || 0) + (d.tex || 0) + (d.repairman || 0)}
                                </p>
                                <p className="text-[11px] mt-1" style={{color: "#94a3b8"}}>
                                    {d.engineer} инженер ·{d.tex} Техникч ·{d.repairman?d.repairman:0} засварчин
                                </p>
                            </div>
                            <div>
                                <div className="flex items-center gap-2 mb-3">
                  ...
                  Нийт хүний тоо
                                ...
                                <div className="h-[3px] rounded-full" style={{background: "#f1f5f9"}}>
                                    <motion.div
                                        ...
                                        style={{background: d.color}}
                                        initial={{width: "0%"}}
                                        animate={{width: `${Math.min(100, (d.engineer + d.tex! + d.repairman!) * 14)}%`}}
                                        transition={{duration: 0.9, ease: [0.4, 0, 0.2, 1]}}
                                    />
                                </div>
                            </div>
