...
const OFFICE_DATA: Record<string, OfficeItem> = {
    "Хяналт удирдлага": {
        id: "ID-01", stats: "", unit: "Хяналт удирдлага",
        desc: "Байгууллагын хэмжээнд SCADA систем, программ хангамж, алсын удирдлага, компьютер, харилцаа холбоо, автоматжуулалтын тоног төхөөрөмжийн найдвартай, 24/7 тасралтгүй ажиллагааг хянах, оношлох, засвар үйлчилгээг зохион байгуулах үндсэн үүрэгтэй.\n" +
            ...
            "\n",
        engineer: 4, tex: 1,
        img: "/src/assets/cctv-3d.png", icon: "🖥️",
...
// ─── Main Component ───────────────────────────────────────────────────────────
export default function Hynalt() {
    const { isDark } = useOutletContext<{ isDark: boolean }>();
    const [activeTab, setActiveTab] = useState("Хяналт удирдлага");
